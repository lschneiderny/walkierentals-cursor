    ...
    <footer className="bg-gray-900 text-white py-12">
      <div className="container mx-auto px-4">
        <div className="grid md:grid-cols-4 gap-8">
          {/* Company Info */}
          <div>
            <h3 className="text-xl font-bold mb-4 text-orange-400">WalkieRentals</h3>
            <p className="text-gray-400 mb-4">
              3321 Poplar Club Pkwy<br />
              Memphis, TN 38125<br />
              (901) 754-9100
            </p>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-2 text-gray-400">
              <li><Link href="/gift-certificates" className="hover:text-white">Gift Certificates</Link></li>
              <li><Link href="/lens-rentals-hd" className="hover:text-white">LensRentals HD</Link></li>
              <li><Link href="/keeper" className="hover:text-white">Keeper</Link></li>
              <li><Link href="/lenscap" className="hover:text-white">Lenscap+</Link></li>
          ...
          <div>
            ...
            <ul className="space-y-2 text-gray-400">
              <li><Link href="/rental-agreement" className="hover:text-white">Rental Agreement</Link></li>
              <li><Link href="/help" className="hover:text-white">Help</Link></li>
              <li><Link href="/our-process" className="hover:text-white">Our Process</Link></li>
              <li><Link href="/contact" className="hover:text-white">Contact Us</Link></li>
              <li><Link href="/refer-a-friend" className="hover:text-white">Refer a Friend</Link></li>
        ...
        <div className="border-t border-gray-800 mt-8 pt-8 flex flex-col md:flex-row justify-between items-center">
          <p className="text-gray-400 text-sm">
            © 2025 WalkieRentals. All rights reserved.
          </p>
